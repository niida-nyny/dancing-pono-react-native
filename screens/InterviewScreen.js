...
const InterviewScreen = ({ navigation }) => {
  ...
  // 最大ページ数をカウントするロジック
  const apiUrl = "https://dance.gdp22.com/wp-json/wp/v2/dance_changes_life"; // WordPress REST APIのエンドポイント
  ...
  async function fetchData() {
    const res = await fetch(
      `https://dance.gdp22.com/wp-json/wp/v2/dance_changes_life?_embed&per_page=10&page=${page}`,
    );
